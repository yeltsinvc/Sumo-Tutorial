# -*- coding: utf-8 -*-
"""
Created on Tue Dec  4 15:55:27 2018
...
class Options(): 
    ...
    def __init__(self, input_name, sep = ';', quot = '', xsd = None,  validation=False, split = False):
        ...
        self.split = split 
        self.xsd = xsd
        self.output = self.source.split('.')[0] 
